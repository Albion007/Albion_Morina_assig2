...
import pdt from '../assets/wiki.png';
...
class Wikipedia extends React.Component {
  ...
  render() {
    ...
    return (
      <div className="App">
        <img style={{ width: "20%", height: "20%" }} src={pdt} alt="Logo" />
        <form action="">
          <input style={{color: "#000000"}} type="text" value={this.state.WikiSearchTerms || ''} onChange={this.changeWikiSearchTerms} placeholder='What do you want to know?' />
